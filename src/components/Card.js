...
const Card = ({img, title, favorite, categoryName, rating, charges, onPress}) => {
  return (
      ...
      <View
        ...
        <View>
          <View style={globalStyles.justifyBtwRow}>
            ...
            <AntDesign name={favorite ? 'heart':'hearto'} size={14} color={"red"} />
          </View>
          <Text>
            <Text style={globalStyles.font14}>{categoryName}</Text>
          </Text>
        </View>
